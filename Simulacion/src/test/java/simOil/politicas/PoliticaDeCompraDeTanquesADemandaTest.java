...
public class PoliticaDeCompraDeTanquesADemandaTest {
    ...
    public void tesTanquesAgua() {
        ...
        pozosCompletados.add(new Pozo(4, 50, new CalculadorPresionPorReinyeccionImpl(), new LoggerAConsola()));
        ...
        Reservorio reservorio = new Reservorio(0.8, 0.0, 0.2, 1000, new LoggerAConsola(), 1000000);
