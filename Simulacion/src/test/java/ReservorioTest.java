...
public class ReservorioTest {
    ...
    public void testVolumenesDelReservorio(){
        ...
        reservorio.reinyectar(volReinyeccion, TipoDeProducto.GAS);
        assert(reservorio.volumenInicial() == volumenInicialReservorio);
    ...
    public void testProporcionDespuesReinyeccion(){
        ...
        reservorio.reinyectar(volReinyeccion, TipoDeProducto.AGUA);
        ...
        reservorio.reinyectar(volReinyeccion2, TipoDeProducto.GAS);
